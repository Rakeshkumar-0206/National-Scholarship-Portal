...
<div class="sidebar">
		...
		<ul class="nav-links">
			<li><a href="dashboardministry" class="active"> <i class="bx bx-grid-alt"></i>
					<span class="links_name">Dashboard</span>
			</a></li>
			<li><a href="#"> <i class="bx bx-box"></i> <span
					class="links_name">Add Scholarship</span>
			</a></li>
			<li><a href="DashboardState"> <i class="bx bx-coin-stack"></i> <span
					class="links_name">Institute Applications</span>
			</a></li>
			<li><a href="MScholarapprove"> <i class="bx bx-book-alt"></i> <span
					class="links_name">Scholarship Application</span>
			</a></li>
