...
<body>
	<div class="sidebar">
		...
		<ul class="nav-links">
			<li><a
				href="http://localhost:8080/NationalScholarshipPortal/DashboardStudent"
			...
			<li><a href="IScholarapprove"> <i class="bx bx-coin-stack"></i>
					<span class="links_name">All Applications</span>
			</a></li>
						...
						<table border="1" class="table">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<form action="ViewScholarship" method="get"
											...
											function submitForm(form) {
												...
												form.action = "ViewScholarship?studentId="
														+ aadharNumber;
												return true;
											}
										</script>
