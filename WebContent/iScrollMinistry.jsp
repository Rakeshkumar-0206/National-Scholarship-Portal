...
<%@ page import="com.entity.InstituteScroll"%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div class="sidebar">
		...
		<ul class="nav-links">
			...
			<li><a href="MScholarapprove"> <i class="bx bx-coin-stack"></i>
	...
	<section class="home-section">
		...
		<div class="sales-boxes">
			<div class="recent-sales box">
				<div class="title">Pending for Institute Approval</div>
				<hr>
				<br> <br>
				<div class="sales-details">
					<%
					List<InstituteScroll> pendingStudents = (List<InstituteScroll>) request.getAttribute("pendingStudents");
					...
					<div style="height: 300px; overflow: auto; width: 100%">
						<table border="1" class="table">
							...
							<tbody>
								<%
								for (InstituteScroll student : pendingStudents) {
								%>
								<tr>
									<td><%=student.getInstituteName()%></td>
									<td><%=student.getInstituteCode()%></td>
									<td><%=student.getDiseCode()%></td>
									<td><%=student.getMobileNumber()%></td>
									<td>
										<form action="ViewMiniInstitute" method="get"
											onsubmit="return submitForm(this)">
											<input type="hidden" name="studentId"
												value="<%=student.getInstituteCode()%>">
											<button type="submit">View form</button>
										</form> <script>
											function submitForm(form) {
												var aadharNumber = form
														.querySelector('input[name="studentId"]').value;
												form.action = "ViewMiniInstitute?studentId="
														+ aadharNumber;
												return true;
											}
										</script>
