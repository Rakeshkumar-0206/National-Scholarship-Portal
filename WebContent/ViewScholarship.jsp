...
<div class="container">
 <h1><center>SCHOLARSHIP DETAILS</center></h1> <br><br>
        ...
        <br>
        <form id="approvalForm" method="post" onsubmit="return submitForm(this)" action="UpdateApprove">
    ...
    <form method="get" onsubmit="return submitFormR(this)" action="rUpdateApprove">
     <input type="hidden" name="studentId" value="${student.aadharNumber}">
...
<script>
    ...
    function submitFormR(form) {
        var aadharNumber = form.querySelector('input[name="studentId"]').value;
        form.action = "rUpdateApprove?studentId=" + aadharNumber;
        return true;
    }
</script>
