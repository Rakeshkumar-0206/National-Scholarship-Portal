...
public class SScholarshipDAO {
	 public static List<Scholarship> getStateScholarship(HttpServletRequest request) {
	        ...
	        try {
	            ...
	            String query1 = "SELECT StudentName, MobileNumber, AadharNumber FROM student where InstituteApproved = 'Yes' and InstiScholarApprove = 'Yes' and StateScholarshipApprove = 'No' ";
