...
public class InstituteScrolllDAO {
	...
	public static List<InstituteScroll> getInstitute(HttpServletRequest request) {
        ...
        try {
            ...
            String query1 = "SELECT InstituteCode, InstituteName, DISCCode from institutes where StateApproved = 'Yes' and MinistryApproved = 'No' ";
