...
import com.service.InstituteScrollDAO;

/**
 * Servlet implementation class DashboardInstitute
 */
...
public class DashboardInstitute extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<InstituteScroll> pendingStudents = InstituteScrollDAO.getInstitute(request); // Assuming you have a DAO class

        // Set the retrieved data as a request attribute
        request.setAttribute("pendingStudents", pendingStudents);

        // Forward the request to the JSP page
        RequestDispatcher dispatcher = request.getRequestDispatcher("iScrollState.jsp");
