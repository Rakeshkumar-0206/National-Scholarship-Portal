...
/**
 * Servlet implementation class ViewSScholarship
 */
@WebServlet("/ViewSScholarship")
public class ViewSScholarship extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("ViewSScholarship.jsp");
