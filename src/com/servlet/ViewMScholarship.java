...
/**
 * Servlet implementation class ViewMScholarship
 */
@WebServlet("/ViewMScholarship")
public class ViewMScholarship extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("ViewMScholarship.jsp");
