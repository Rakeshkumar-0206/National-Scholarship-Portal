...
/**
 * Servlet implementation class ViewInstitute
 */
@WebServlet("/ViewInstitute")
public class ViewInstitute extends HttpServlet {
	private static final long serialVersionUID = 1L;
	 ...
	 protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("ViewInstitute.jsp");
